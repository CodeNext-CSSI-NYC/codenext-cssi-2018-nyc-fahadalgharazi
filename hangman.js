...
let randWord = wordsToPickFrom[randomInt(100)];
...
// function to print out the array.
 let question = readline.question("enter a letter =-=->");

 for(i = 0;i<randWord.length;i++){
 	if(question.charAt() == randWord.charAt(i)){
 		space.push(randWord.charAt(i));
 	}
 	else{
 		let question = readline.question("enter a letter =-=->");
 	}
