...
//   chosenOne = cafes[randomInt(cafes.length - 1)];
//   return chosenOne;
// }
// console.log(lunch());
...
let typeScore = readline.question("type in TD/touchdown and FG/field goal or you could type anything else");
let currentScore = 0;
function football() {
	//while(currentScore != 30 || typeScore == "TD" || typeScore == "touchdown" || typeScore == "Fg" || typeScore == "field goal"){
		if(typeScore == "TD" || typeScore == "touchdown"){
			currentScore += 7;

		}
		else if(typeScore == "Fg" || typeScore == "field goal" ){
			currentScore += 3;
		}
		else{
			return console.log(currentScore + " Is your total points");
		}
	}
